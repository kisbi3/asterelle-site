...
Pages from the separate public repo `kisbi3/labmates-site` (the main repo is
...
- Live URL: https://kisbi3.github.io/labmates-site/
...
```bash
git clone https://github.com/kisbi3/labmates-site.git /tmp/labmates-site
rsync -av --delete --exclude .git site/ /tmp/labmates-site/
cd /tmp/labmates-site && git add -A && git commit -m "sync landing page" && git push
```
